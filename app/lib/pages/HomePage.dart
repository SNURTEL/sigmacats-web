              ...
              itemBuilder: (context, index) {
                return Column(
                  children: [
                    ...
                    SizedBox(width: math.max(math.min(40.h, 300), 600), child: RaceCard(snapshot.data![index], dio)),
                    SizedBox(height: 8.0),
                    Visibility(
            ...
            Row(
              children: [
                Column(
                  ...
                  children: [
                    ConstrainedBox(
                      constraints: BoxConstraints(maxWidth: math.max(math.min(40.h, 300), 600) - 144),
                      child: Text(
                        race.name,
                        softWrap: true,
